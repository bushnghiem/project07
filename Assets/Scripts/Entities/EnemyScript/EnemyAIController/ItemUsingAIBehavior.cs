...
[CreateAssetMenu(menuName = "AI/Item AI")]
public class ItemUsingAIBehavior : EnemyAIBehavior
{
    [Header("Behavior")]
        ...
        EnemyAIContext context)
    {
        ...
        UnitAction itemAction = null;

        AIItemCandidate itemCandidate =
            EnemyItemAIUtility.EvaluateItem(
                enemy,
                battleManager,
                context);
        ...
        {
            itemAction =
                EnemyItemAIUtility.CreateItemAction(
                    enemy,
                    itemCandidate);

            if (!itemAction.CanAfford())
                itemAction = null;
        }

        if (itemAction != null)
        {
            candidates.Add(itemAction);
        }
