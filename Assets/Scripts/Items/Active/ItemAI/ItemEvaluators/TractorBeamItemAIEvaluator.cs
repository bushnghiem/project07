...
[CreateAssetMenu(menuName = "AI/Items/Tractor Beam Evaluator")]
public class TractorBeamItemAIEvaluator : ActiveItemAIEvaluator
{
    [Header("Scoring")]
        ...
        ActiveItemInstance item)
    {
        ...
        foreach (Unit unit in players)
        {
            ...
            float distance01 =
                ...
                Mathf.Clamp01(
                    distance /
                    item.itemData.effectRadius);

            score +=
                playerHitWeight +
                distance01 * distanceWeight;
        }
